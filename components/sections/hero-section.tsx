      ...
      <nav className="relative z-20 flex items-center justify-between p-6 lg:px-12">
        <div className="flex items-center space-x-2">
          <div className="w-10 h-10 bg-gradient-to-br from-amber-600 to-orange-700 rounded-full flex items-center justify-center shadow-lg">
            <Nut className="w-5 h-5 text-white" />
          </div>
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="#products" className="text-amber-900 hover:text-amber-700 font-medium transition-colors">
            Sản phẩm
          </a>
          <a href="#story" className="text-amber-900 hover:text-amber-700 font-medium transition-colors">
            Câu chuyện
          </a>
          <a href="#contact" className="text-amber-900 hover:text-amber-700 font-medium transition-colors">
            Liên hệ
          </a>
          <Button className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white shadow-lg hover:shadow-xl transition-all hover:scale-105">
            Đặt hàng ngay
          </Button>
        </div>
      </nav>
